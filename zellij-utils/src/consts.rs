...
pub const RELAY_TUNNEL_AUTH_TOKEN_ENV: &str = "ZELLIJ_RELAY_TUNNEL_AUTH_TOKEN";
pub const RELAY_TUNNEL_AUTH_TOKEN_FILE_ENV: &str = "ZELLIJ_RELAY_TUNNEL_AUTH_TOKEN_FILE";
pub const RELAY_TUNNEL_AUTH_TOKEN_ASKPASS_ENV: &str = "ZELLIJ_RELAY_TUNNEL_AUTH_TOKEN_ASKPASS";
pub const VERSION: &str = env!("CARGO_PKG_VERSION");
pub const DEFAULT_RELAY_SERVER_URL: &str = "wss://relay.zellij.online";
